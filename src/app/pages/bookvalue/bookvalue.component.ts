...
@Component({
  selector: 'app-bookvalue',
  templateUrl: './bookvalue.component.html',
  styleUrls: ['./bookvalue.component.scss']
})
export class BookvalueComponent implements OnInit {
  ...
  fileChangeZ(element:any)
  {
    ...
    formData.append('excel', uploadedFiles[0],uploadedFiles[0].name);
      ...
      const Url = this.Commonservice.Url + 'bookmarketupload'
