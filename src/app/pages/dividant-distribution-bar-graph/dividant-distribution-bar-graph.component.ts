...
@Component({
  selector: 'app-dividant-distribution-bar-graph',
  templateUrl: './dividant-distribution-bar-graph.component.html',
  styleUrls: ['./dividant-distribution-bar-graph.component.scss']
})
export class DividantDistributionBarGraphComponent implements OnInit {
  ...
  fileChangeZ(element:any)
  {
    ...
    formData.append('excel', uploadedFiles[0],uploadedFiles[0].name);
      ...
      const Url = this.Commonservice.Url + 'ddxlupload'
