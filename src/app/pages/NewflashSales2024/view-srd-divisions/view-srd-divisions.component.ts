...
@Component({
  selector: 'app-view-srd-divisions',
  templateUrl: './view-srd-divisions.component.html',
  styleUrls: ['./view-srd-divisions.component.scss']
})
export class ViewSrdDivisionsComponent implements OnInit {
    ...
    clearfilter()
    {
      ...
      this.Seldiv=this.LoginData.DivisionId,
      this.Selmon=''
      this.Selunit=''
      this.finy=''
