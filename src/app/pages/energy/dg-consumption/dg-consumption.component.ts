...
@Component({
  selector: 'app-dg-consumption',
  templateUrl: './dg-consumption.component.html',
  styleUrls: ['./dg-consumption.component.scss']
})
export class DgConsumptionComponent implements OnInit {
