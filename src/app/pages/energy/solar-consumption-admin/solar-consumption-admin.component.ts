...
@Component({
  selector: 'app-solar-consumption-admin',
  templateUrl: './solar-consumption-admin.component.html',
  styleUrls: ['./solar-consumption-admin.component.scss']
})
export class SolarConsumptionAdminComponent implements OnInit {
