...
@Component({
  selector: 'app-consumption-admin',
  templateUrl: './consumption-admin.component.html',
  styleUrls: ['./consumption-admin.component.scss']
})
export class ConsumptionAdminComponent implements OnInit {
