...
@Component({
  selector: 'app-solar-summary-consumption',
  templateUrl: './solar-summary-consumption.component.html',
  styleUrls: ['./solar-summary-consumption.component.scss']
})
export class SolarSummaryConsumptionComponent implements OnInit {
    ...
    LetExcel=
  {
    ...
    IsForeCast:false,
    Name:'Solar Energy Consumption Summary'
  }
