...
@Component({
  selector: 'app-csragency',
  templateUrl: './csragency.component.html',
  styleUrls: ['./csragency.component.scss']
})
export class CsragencyComponent implements OnInit {
  ...
  fileChangeZ(element:any)
  {
    ...
    formData.append('excel', uploadedFiles[0],uploadedFiles[0].name);
      ...
      const Url = this.Commonservice.Url + 'csragenxlupload'
